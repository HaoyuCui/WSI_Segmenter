...
from dataset import TSR_CRC_Dataset
...
# get tsr-crc dataset from Zenodo: https://zenodo.org/records/4024676
if __name__ == '__main__':
    ...
    dataset_train = TSR_CRC_Dataset(data_dir=data_dir,
                                    mode='train')
    dataset_val = TSR_CRC_Dataset(data_dir=data_dir,
                                    mode='val')
